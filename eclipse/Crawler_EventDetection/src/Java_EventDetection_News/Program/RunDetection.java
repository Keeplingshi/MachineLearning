...
import Java_EventDetection_News.Label.ConnectLabelDB;
...
public class RunDetection {
	...
	public RunDetection() {
		ne = new NerExtract();
		String sqlurl = "jdbc:mysql://localhost:3306/webnews";
		String sqluser = "root";
	...
	public void LoadLabelDB(String sqlUserName, String sqlUserPassw, String sqlURL) {
		...
		// Trigger_Role.dm = new
		// Actors_Db_Methods(sqlURL,sqlUserName,sqlUserPassw);
	}
	...
	/**
	 * 更新模板，使用新的训练数据更新模板 存储模板的文本文件也会被修改
	 * 
	 */
	 ...
	 * @newsInput 新闻输入文本
	 * @triggerWord 触发词
	 * @result 结果对象 result.sourceActor result.targetActor
	 */
	@SuppressWarnings("static-access")
	public void setActor(String newsSource, String newsID, String newsInput, String newsTime, String triggerWord,
			LabelItem result) {
		String[] temp = new String[2];
		if (newsInput != null || "".equals(newsInput)) {
	...
	public LabelItem GetEventInforfromNews(String newsSource, String newsID, String newsTime, String newsTitle)
...
//		// 初始化
//		demoTest.LoadLabelDB("root", "root", "jdbc:mysql://localhost/webnews");
//		demoTest.LoadTemplateController("E:/Github/MachineLearning/eclipse/Crawler_EventDetection/src/cue.csv");
...
//		String newsTitle = "小米发布了MIX，获得了广泛赞誉。";
//		
